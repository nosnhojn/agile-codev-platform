...
%s
*constraints2t
`Time (s): cpu = 00:00:00.67 ; elapsed = 00:00:00.80 . Memory (MB): peak = 914.441 ; gain = 0.0002default:default


Phase %s%s
101*constraints2
...
S
GPhase 1.2 Build Super Logic Region (SLR) Database | Checksum: e670c54c
*common
‹

%s
*constraints2t
`Time (s): cpu = 00:00:00.69 ; elapsed = 00:00:00.83 . Memory (MB): peak = 914.441 ; gain = 0.0002default:default
i

Phase %s%s
101*constraints2
...
%s
*constraints2n
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:03 . Memory (MB): peak = 914.441 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
M
APhase 1.6 Implementation Feasibility check | Checksum: 1139afa4d
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:04 ; elapsed = 00:00:05 . Memory (MB): peak = 914.441 ; gain = 0.0002default:default
i

Phase %s%s
101*constraints2
...
<
0Phase 1.7 Pre-Place Cells | Checksum: 1139afa4d
*common
…

%s
...
_
SPhase 1.8 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 1139afa4d
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:07 ; elapsed = 00:00:08 . Memory (MB): peak = 922.441 ; gain = 8.0002default:default
t

Phase %s%s
101*constraints2
...
@
4Phase 1.9.1.1 Build Clock Data | Checksum: 689b4b98
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:16 ; elapsed = 00:00:13 . Memory (MB): peak = 922.441 ; gain = 8.0002default:default
?
3Phase 1.9.1 Place Init Design | Checksum: f331154d
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:16 ; elapsed = 00:00:14 . Memory (MB): peak = 922.441 ; gain = 8.0002default:default
F
...
O
CPhase 1.10.1 Constrain Global/Regional Clocks | Checksum: e485746b
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:17 ; elapsed = 00:00:14 . Memory (MB): peak = 922.441 ; gain = 8.0002default:default
D
8Phase 1.10 Constrain Clocks/Macros | Checksum: e485746b
*common
…

%s
...
ZTime (s): cpu = 00:00:17 ; elapsed = 00:00:14 . Memory (MB): peak = 922.441 ; gain = 8.0002default:default
?
3Phase 1 Placer Initialization | Checksum: e485746b
*common
…

%s
...
%s
*constraints2o
[Time (s): cpu = 00:01:26 ; elapsed = 00:00:55 . Memory (MB): peak = 934.660 ; gain = 20.2192default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:01:32 ; elapsed = 00:00:59 . Memory (MB): peak = 938.668 ; gain = 24.2272default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 13a4e5208
*common
†

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 164489e83
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:35 ; elapsed = 00:01:01 . Memory (MB): peak = 940.074 ; gain = 25.6332default:default
z

Phase %s%s
101*constraints2
...
T
HPhase 3.5 Commit Small Macros & Core Logic | Checksum: ffffffffdba5a16a
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:40 ; elapsed = 00:01:06 . Memory (MB): peak = 948.078 ; gain = 33.6372default:default
l

Phase %s%s
101*constraints2
...
%s
*constraints2o
[Time (s): cpu = 00:01:41 ; elapsed = 00:01:07 . Memory (MB): peak = 948.078 ; gain = 33.6372default:default
B
6Phase 3 Detail Placement | Checksum: ffffffffdba5a16a
*common
†

%s
...
D
8Phase 4.1.1 Restore Best Placement | Checksum: 7b4f0510
*common
†

%s
*constraints2o
[Time (s): cpu = 00:01:58 ; elapsed = 00:01:22 . Memory (MB): peak = 952.484 ; gain = 38.0432default:default
N
BPhase 4.1 Post Placement Timing Optimization | Checksum: 7b4f0510
*common
†

%s
...
B
6Phase 4.2 Post Placement Cleanup | Checksum: 7b4f0510
*common
†

%s
...
B
6Phase 4.3.1 Congestion Reporting | Checksum: 7b4f0510
*common
†

%s
...
B
6Phase 4.3.2 Dump Critical Paths  | Checksum: 7b4f0510
*common
†

%s
...
2*	placeflow20
| WNS=-2.466 | TNS=-36.887|
2default:defaultZ30-100
=
1Phase 4.3.4 Print Final WNS | Checksum: 7b4f0510
*common
†

%s
*constraints2o
[Time (s): cpu = 00:02:08 ; elapsed = 00:01:28 . Memory (MB): peak = 958.891 ; gain = 44.4492default:default
<
0Phase 4.3 Placer Reporting | Checksum: f842dd0a
*common
†

%s
*constraints2o
[Time (s): cpu = 00:02:09 ; elapsed = 00:01:28 . Memory (MB): peak = 958.891 ; gain = 44.4492default:default
q

Phase %s%s
101*constraints2
...
D
8Phase 4.4 Final Placement Cleanup | Checksum: 14a4ce0f1
*common
†

%s
...
[Time (s): cpu = 00:02:09 ; elapsed = 00:01:28 . Memory (MB): peak = 958.891 ; gain = 44.4492default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 14a4ce0f1
*common
†

%s
...
958.8912default:default2
44.4492default:defaultZ17-268
`
...

ureport_utilization: Time (s): cpu = 00:00:00.32 ; elapsed = 00:00:00.38 . Memory (MB): peak = 960.891 ; gain = 0.000
*common
m
