...
XAxiVdma          * DisplayXilTest::vdma() { return &(cfg.axiVdma); }
XAxiVdma_DmaSetup * DisplayXilTest::vdmaCfg() { return &(cfg.axiVdmaCfg); }
XVtc_Polarity * DisplayXilTest::xvtcPolarity() { return display->getXvtcPolarity(); }
XVtc_Signal * DisplayXilTest::xvtcSignal() { return display->getXvtcSignal(); }
XVtc_SourceSelect * DisplayXilTest::xvtcSourceSelect() { return display->getXvtcSourceSelect(); }

int DisplayXilTest::width() { return display->getWidth(); }
int DisplayXilTest::height() { return display->getHeight(); }
